...
void Template_Module::dataFromJson(json_t* root)
{
...
json_t* Template_Module::dataToJson()
{
...
// IChemClient
::rack::engine::Module* Template_Module::client_module() { return this; }
std::string Template_Module::client_claim() { return device_claim; }

void Template_Module::onConnectHost(IChemHost* host)
{
    onConnectHostModuleImpl(this, host);
}

void Template_Module::onPresetChange()
{
...
void Template_Module::onConnectionChange(ChemDevice device, std::shared_ptr<MidiDeviceConnection> connection)
{
    if (chem_ui) ui()->onConnectionChange(device, connection);
}

void Template_Module::do_message(PackedMidiMessage message)
{
...
void Template_Module::process_params(const ProcessArgs& args)
{
    //modulation.pull_mod_amount();
}

void Template_Module::process(const ProcessArgs& args)
{
...
Model *modelTemplate_ = createModel<Template_Module, Template_Ui>("chem-proto");
